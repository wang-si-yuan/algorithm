    ...
    private class AlgoCanvas extends JPanel{
        ...
        public void paintComponent(Graphics g) {
            ...
            for(int i = 0 ; i < data.N() ; i ++ ) {
                if (data.orderedIndexStart <= i && i <= data.orderedIndexEnd)
                ...
                if(i == data.currentMaximumIndex)
                    ViewDataHelper.setColor(g2d, ViewDataHelper.Indigo);
                ViewDataHelper.fillRectangle(g2d, i * w, canvasHeight - data.get(i), w - 1, data.get(i));
            }
        }
